...
const SNS_CARDS = [
  {
    ...
    tag: "Instagram",
    caption:
      "인기 IP 콜라보를 화보형 피드로 기획해 브랜드 인지도를 끌어올렸습니다. 콜라보의 화제성을 오가닉 도달로 연결하고 저장·공유를 유도해, 잠재 고객의 방문 욕구를 자극하는 상단 퍼널 콘텐츠로 설계했습니다.",
  },
  {
    img: "insta2",
    tag: "Instagram",
    caption:
      "브랜드 코어 메시지 ‘내 톤을 찾다’를 릴스 룩북으로 제작해 숏폼 알고리즘 기반 오가닉 도달을 극대화했습니다. 브랜드 무드와 차별점을 짧고 강하게 각인시켜, 인지에서 방문 고려로 넘어가는 전환을 노린 콘텐츠입니다.",
    video: "1번 시안 영상.mp4",
  },
  {
    img: "insta3",
    tag: "Threads",
    caption:
      "쓰레드의 대화형 포맷에 맞춰 반려동물을 훅(hook)으로 설계했습니다. 공감 코드로 댓글·리포스트 인게이지먼트를 유도해 오가닉 바이럴을 만들고, 반려인이라는 신규 타깃 세그먼트까지 브랜드 접점을 확장했습니다.",
  },
  {
    img: "insta4",
    tag: "Threads",
    caption:
      "반려동물 동반 촬영 기능을 ‘집사’ 화법의 UGC 유도형 콘텐츠로 풀어냈습니다. 실사용 맥락과 후기를 대화체로 전달해 방문 전환을 유도하고, 인증 참여(UGC)로 재방문 루프를 설계했습니다.",
  },
];
