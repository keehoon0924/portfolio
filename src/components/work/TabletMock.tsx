...
export default function TabletMock({ title }: TabletMockProps) {
  return (
    <div className="relative z-[2] mb-1 ml-[-26px] h-[250px] w-[188px] flex-none rounded-[20px] bg-[#1c1c1e] p-[11px] shadow-[0_30px_60px_-32px_rgba(22,24,27,0.45)]">
      <div className={`${screenClassName} inset-[11px] rounded-[11px]`}>
